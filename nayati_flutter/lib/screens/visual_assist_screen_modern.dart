              ...
              child: SafeArea(
                child: Row(
                  ...
                  children: [
                    ...
                    _buildModernButton(
                      icon: _narrationService?.isNarrating == true ? Icons.stop : Icons.volume_up,
                      onPressed: () {
                      ...
                      tooltip: _narrationService?.isNarrating == true ? 'Stop Narration' : 'Narrate Objects',
                      backgroundColor: _narrationService?.isNarrating == true ? Colors.red : const Color(0xFF16A34A),
                    ),
                  ],
                ),
              ),
            ...
            Row(
              children: [
                Expanded(
                  child: _buildStatCard(
                    'Narration',
                    _narrationService?.isNarrating == true ? 'Speaking' : 'Ready',
                    _narrationService?.isNarrating == true ? Icons.volume_up : Icons.volume_off,
                    _narrationService?.isNarrating == true ? const Color(0xFF16A34A) : const Color(0xFF6B7280),
                  ),
                ),
                const SizedBox(width: 12),
                Expanded(
                ...
                Expanded(
                  child: _buildStatCard(
                    'TTS Status',
                    _narrationService?.isEnabled == true ? 'Enabled' : 'Disabled',
                    _narrationService?.isEnabled == true ? Icons.check_circle : Icons.cancel,
                    _narrationService?.isEnabled == true ? const Color(0xFF16A34A) : const Color(0xFFEF4444),
                  ),
                ),
              ],
            ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              _buildControlButton(
                icon: _narrationService?.isNarrating == true ? Icons.stop : Icons.volume_up,
                label: _narrationService?.isNarrating == true ? 'Stop' : 'Narrate',
                onPressed: () {
                  if (_narrationService?.isNarrating == true) {
                    _narrationService?.stopNarration();
                  } else {
              ...
              children: [
                ...
                Expanded(
                  child: DropdownButton<String>(
                    ...
                    isExpanded: true,
                    items: (_narrationService?.supportedLanguages ?? ['English']).map((String language) {
